...
export function GameProvider({ children }: { children: ReactNode }) {
  ...
  const equipClothing = useCallback((id: string | null) => {
    const p = playerRef.current; if (!p) return;
    if (!id || id === "") {
      patch({
        roupaEquipada: "",
        cor: "#3f7ad6", // cor básica padrão
        camisaModelo: p.sexo === "feminino" ? "blusa" : "camiseta",
        inferiorModelo: p.sexo === "feminino" ? "saia" : "calca",
        calcaCor: "#2f3b57",
        sapatoModelo: "tenis",
        sapatoCor: "#1a1f2c",
        camisaImagem: "",
      ...
      notify("👕 Roupa removida. Você voltou ao visual básico.", "info");
      return;
    }
    ...
    patch({
      ...
      camisaTransform: clothing.imageTransform ?? { x: 0, y: 0, scaleX: 1, scaleY: 1, rotation: 0 },
    });
